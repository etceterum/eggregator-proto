...
module ActionView::Helpers::AssetTagHelper
   ...
   def theme_stylesheet_path( source=nil, theme=nil )
      ...
      compute_public_path(source || "theme", "stylesheets/themes/#{theme}", 'css')
   end
   ...
   def theme_image_path( source, theme=nil )
      ...
      compute_public_path(source, "images/themes/#{theme}", 'png')
   end
   ...
   def theme_javascript_path( source, theme=nil )
      ...
      compute_public_path(source, "javascripts/themes/#{theme}", 'js')
   end
